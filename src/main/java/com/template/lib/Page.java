...
import com.template.lib.allurehelper.ParamsHelper;
import com.template.lib.annotations.ActionTitle;
import com.template.lib.annotations.ActionTitles;
...
import com.template.lib.exceptions.*;
import com.template.lib.extensions.DriverExtension;
import com.template.lib.extensions.WebExtension;
import com.template.lib.support.AdbConsole;
...
public abstract class Page {
    ...
    @ActionTitle("com.template.pagefactory.fill.field")
    public void fillField(String elementTitle, String text) throws PageException {
        ...
        if (PageFactory.getEnvironment() == Environment.MOBILE && MobileDriver.getAppiumClickAdb()) {
     ...
     * @throws PageException if page was not
     *                       initialized, or required element couldn't be found
     */
    @ActionTitles({
            @ActionTitle("com.template.pagefactory.click.link"),
            @ActionTitle("com.template.pagefactory.click.button")})
     ...
     */
    @ActionTitle("com.template.pagefactory.press.key")
     ...
     * @throws ElementNotFoundException if
     ...
     *                       initialized, or required element couldn't be found
     */
    @ActionTitle("com.template.pagefactory.select.checkBox")
     ...
     *                       timeout
     */
    @ActionTitle("com.template.pagefactory.accept.alert")
     ...
     *                       timeout
     */
    @ActionTitle("com.template.pagefactory.dismiss.alert")
     ...
     *                       timeout
     */
    @ActionTitle("com.template.pagefactory.text.appears.on.page")
     ...
     */
    @ActionTitle("com.template.pagefactory.text.absent.on.page")
     ...
     * @throws WaitException if
     */
    @ActionTitle("com.template.pagefactory.modal.window.with.text.appears")
     ...
     * @throws PageException if current page
     *                       was not initialized, or element wasn't found on the page
     */
    @ActionTitle("com.template.pagefactory.check.field.not.empty")
     ...
     */
    @ActionTitle("com.template.pagefactory.check.values.not.equal")
     ...
     */
    @ActionTitles({
            @ActionTitle("com.template.pagefactory.check.element.with.text.present"),
            @ActionTitle("com.template.pagefactory.check.text.visible")})
     ...
     * @throws PageException if failed to
